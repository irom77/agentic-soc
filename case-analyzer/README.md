...
This package runs the Case Analysis LLM workflow without Django, PostgreSQL, or the Agentic SOC worker. It accepts exported security-case JSON, normalizes it to a platform-neutral representation, and returns a structured `InvestigationReport` JSON document.
